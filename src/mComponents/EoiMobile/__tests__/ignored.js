...
describe('EoiMobile connectionStatus: ignored', () => {
  ...
  const buttonsSet = [{ index: 0, type: 'connect now', text: 'Connect Now', onClickArgs: ['connect_mobile'] }];
  ...
  it('should have correct title and description', () => {
    ...
    expect(p.at(0).text()).toEqual('Ignored Member');
