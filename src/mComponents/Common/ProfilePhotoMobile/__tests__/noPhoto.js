...
describe('ProfilePhotoMobile albumStatus: noPhoto', () => {
  ...
  const buttonsSet = [{ index: 0, type: 'request photo', text: 'Request a Photo', onClickArgs: ['request_photo_mobile'] }];
  ...
  it('should have correct message', () => {
    expect(profilePhotoMobile.text()).toContain('No Photo');
  });
