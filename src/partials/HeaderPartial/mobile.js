    ...
    return (
      <div>
        ...
        <Header
          ...
          topNavExperimentsAB={this.props.topNavExperimentsAB}
...
HeaderPartial.propTypes = {
  ...
  topNavExperimentsAB: PropTypes.string.isRequired,
...
const selector = state => {
  ...
  const topNavExperimentsAB = (session.settings.experiments && session.settings.experiments.near_me.bucket) || '';
  return {
