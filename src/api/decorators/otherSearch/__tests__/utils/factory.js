...
const C_PAY_criteria = {
  operands: {
    gender: ['Female'],
    age: { operator: 'between', operands: ['23', '27'] },
    height: { operator: 'between', operands: ['58', '72'] },
    maritalstatus: ['Never Married'],
    religion: ['Hindu'],
    mothertongue: ['Hindi'],
    caste: [{ religion: 'Hindu', caste: 'Yadav' }],
...
const C_EXP_criteria = {
  items: [
    { key: 'searchfor-count', term: 'count', value: 'undefined profiles found : ' },
    { key: 'searchfor-gender', term: 'Gender', value: 'Female' },
    {},
    { key: 'searchfor-photostatus', term: 'Photo Settings', value: '' },
    { key: 'searchfor-astroProfile', term: 'Astro data', value: 'Yes' },
    { key: 'searchfor-age', term: 'Age', value: '23 - 27' },
    { key: 'searchfor-height', term: 'Height', value: '4ft 10in - 147 to 6ft 0in - 182' },
    { key: 'searchfor-caste', term: 'Religion / Community', value: 'Hindu:Yadav' },
    { key: 'searchfor-education', term: 'Education', value: '' },
    { key: 'searchfor-working', term: 'Working With', value: '' },
    { key: 'searchfor-occupationarea', term: 'Profession Area', value: '' },
    { key: 'searchfor-workingAs', term: 'Working As', value: '' },
    { key: 'searchfor-annualIncome', term: 'Annual Income', value: '' },
    { key: 'searchfor-maritalStatus', term: 'Marital Status', value: 'Never Married' },
    { key: 'searchfor-children', term: 'Have Children', value: '' },
    { key: 'searchfor-country', term: 'Country Living in', value: 'India' },
    { key: 'searchfor-gothra', term: 'Gothra/ Gothram', value: '' },
    { key: 'searchfor-state', term: 'State Living in', value: '' },
    { key: 'searchfor-city', term: 'City', value: '' },
    { key: 'searchfor-residencyStatus', term: 'Residency Status', value: '' },
    { key: 'searchfor-complextion', term: 'Skin Tone', value: '' },
    { key: 'searchfor-bodytype', term: 'Body Type', value: '' },
    { key: 'searchfor-smoke', term: 'Smoke', value: '' },
    { key: 'searchfor-drink', term: 'Drink', value: '' },
    { key: 'searchfor-diet', term: 'Diet', value: '' },
    { key: 'searchfor-motherTongue', term: 'Mother Tongue', value: 'Hindi' },
    { key: 'searchfor-specialCases', term: 'Special Cases', value: 'No' },
    { key: 'searchfor-keyword', term: 'Keyword', value: '' },
    { key: 'searchfor-doNotShowProfiles', term: 'Do Not Show', value: 'Profiles that have Filtered me out,Profiles that I have Ignored' },
    { key: 'searchfor-postedBy', term: 'Posted By', value: '' },
    { key: 'searchfor-grewupIn', term: 'Country Grew up in', value: '' },
    { key: 'searchfor-accType', term: 'Account Type', value: "Doesn't Matter" },
  ],
};
...
it('should export profiles and props', () => {
  expect(Object.keys(factory).length).toEqual(14);
});
