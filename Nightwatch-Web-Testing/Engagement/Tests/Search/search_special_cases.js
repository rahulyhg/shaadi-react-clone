...
module.exports = {
  ...
  '@tags': ['lib_check','lib_special_search'],
  
    'Fillout special cases search page details' : (browser) => {
    ...
    menu.visitMenu("search","special cases");

    advance_search.setCase(test_data["dropdown"]["special_case"]);
