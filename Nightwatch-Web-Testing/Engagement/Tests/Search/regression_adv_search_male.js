...
module.exports = {
    ...
    before : function(browser)
    {
        ...
        let username = profile_test_data["adv_search_male"][AB][environment][0];
        let pass = profile_test_data["adv_search_male"][AB][environment][1];

        login.quickLogin(username, pass);
    },

    'Verify Default selected “Looking for” should be Groom': (browser) => {
        // LIBARARY INITIALIZE
        browser.waitForElementPresent('//input[@id="gender-Female" and @checked = "checked"]');
    },
